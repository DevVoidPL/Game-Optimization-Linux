...
Item {
    ...
    function logGamesLifecycle(event, details) {
        console.info("Game Optimization Games lifecycle"
                     + " event=" + String(event)
                    ...
                    delegate: ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            AppButton {
                                ...
                                compact: true
                                kind: "ghost"
                                text: qsTr("Forget in Game Optimization")
                                onClicked: {
                                    page.pendingForgetPath = String(
                                        librarySummaryRow.modelData.libraryPath || "")
                                    forgetLibraryDialog.ask(
                                        qsTr("Forget this library in Game Optimization?"),
                                        qsTr("Games and updates from this path will be hidden only in Game Optimization. Steam configuration and user files will not be changed. You can restore the library in Settings.\n\n%1")
                                            .arg(page.pendingForgetPath),
                                        qsTr("Forget in Game Optimization"),
                                        true,
