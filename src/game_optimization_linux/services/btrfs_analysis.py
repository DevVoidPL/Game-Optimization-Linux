...
from game_optimization_linux.models.enums import CompressionProfile, FilesystemType
...
class BtrfsCompressionAnalyzer:
    ...
    def _measure_host(
        ...
        if not callable(analyze):
            raise RuntimeError("Game Optimization host component does not support analysis")
        payload = analyze(game)
        if not isinstance(payload, Mapping):
            raise RuntimeError("Game Optimization host component returned invalid analysis data")
