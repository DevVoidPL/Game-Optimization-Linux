"""Standalone Steam command wrapper for saved GameForge profiles."""
...
def _arguments(argv: Sequence[str]) -> tuple[str, bool, list[str]]:
    ...
    parser = argparse.ArgumentParser(prog="gameforge-run")
...
def main(
    ...
    *,
    ...
    try:
        ...
        print(f"gameforge-run: {error}", file=sys.stderr)
        return 2
