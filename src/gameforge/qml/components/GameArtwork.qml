...
Item {
    ...
    readonly property bool diagnosticLoggingEnabled:
        typeof gameforgeDebugArtwork !== "undefined"
        && gameforgeDebugArtwork === true
    ...
    function logArtworkChange(reason, imageItem) {
        ...
        console.info("GameForge GameArtwork lifecycle"
                     + " event=" + reason
    ...
    function rejectPendingImage(requestToken, requestedGameId, requestedSource) {
        ...
        console.warn("GameForge artwork image error"
                     + " gameId=" + String(gameId)
