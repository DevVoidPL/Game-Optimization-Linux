        ...
        ColumnLayout {
            ...
            SurfaceCard {
                ...
                contentItem: ColumnLayout {
                    spacing: 9
                    Label { text: qsTr("GameForge recommendation"); color: App.Theme.text; font.pixelSize: 19; font.weight: Font.Bold }
            ...
            SurfaceCard {
                ...
                contentItem: ColumnLayout {
                    ...
                    Label { Layout.fillWidth: true; text: qsTr("Proton overrides: %1").arg(tab.protonOverrides.length ? tab.protonOverrides.join("; ") : qsTr("none")); color: App.Theme.textSecondary; wrapMode: Text.WordWrap }
                }
            }
            ...
            SurfaceCard {
                ...
                contentItem: ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        AppButton { text: qsTr("Test runner"); kind: "secondary"; onClicked: if (tab.controller && tab.controller.testGameForgeRunner) tab.controller.testGameForgeRunner(tab.gameId) }
                    }
