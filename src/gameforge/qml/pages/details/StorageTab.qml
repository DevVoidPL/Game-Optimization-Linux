...
Item {
    ...
    function confirmationMessage(plan) {
        ...
        var sharingLine = sharedState === "detected"
                ...
                : qsTr("No shared extents were detected by the analysis. GameForge will recheck each file immediately before recompression.")
        var lines = [
                    ...
                    SurfaceCard {
                        ...
                        contentItem: ColumnLayout {
                            ...
                            GridLayout {
                                ...
                                LabeledValue {
                                    objectName: "lastGameForgeOperationReclaimed"
                                    Layout.fillWidth: true
                                    label: qsTr("Reclaimed during the last GameForge operation")
                            ...
                            Label {
                                Layout.fillWidth: true
                                text: qsTr("Current total saving may predate GameForge. Only a valid compsize before/after pair is attributed to the last GameForge operation.")
                                color: App.Theme.textMuted
                                font.pixelSize: App.Theme.fontCaption
                                wrapMode: Text.WordWrap
                            }
            ...
            SurfaceCard {
                ...
                contentItem: RowLayout {
                    ...
                    ColumnLayout {
                        ...
                        Label {
                            Layout.fillWidth: true
                            text: qsTr("Recursive directory defragmentation remains disabled. GameForge processes verified files individually and requires manual confirmation when snapshots or reflinks make data shared.")
                            color: App.Theme.textSecondary
                            font.pixelSize: App.Theme.fontCaption
                            wrapMode: Text.WordWrap
                        }
