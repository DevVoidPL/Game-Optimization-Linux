        ...
        ColumnLayout {
            ...
            SurfaceCard {
                ...
                contentItem: ColumnLayout {
                    ...
                    Label {
                        Layout.fillWidth: true
                        text: qsTr("Off is the safe default. When enabled, GameForge may queue compression only while the application is open and only after every Btrfs safety check succeeds.")
                ...
                contentItem: ColumnLayout {
                    ...
                    ColumnLayout {
                        ...
                        SettingRow {
                            ...
                            description: qsTr("Choose what the GameForge window should do")
                            AppComboBox {
                ...
                contentItem: ColumnLayout {
                    ...
                    SettingRow {
                        ...
                        description: page.controller && page.controller.demoMode
                                     ? qsTr("Demo data is active because GAMEFORGE_DEMO=1")
                    ...
                    Label {
                        ...
                        text: qsTr("Libraries forgotten in GameForge")
                        color: App.Theme.text
                        font.pixelSize: App.Theme.fontBody
                        font.weight: Font.DemiBold
                    }
