...
from gameforge.models.enums import CompressionProfile, TaskStatus, TaskType
from gameforge.models.game import Game
from gameforge.models.task import TERMINAL_TASK_STATUSES, Task
from gameforge.providers.base import CompressionProvider
from gameforge.providers.demo import DemoCompressionProvider

from .contracts import TaskService


class TaskServiceError(RuntimeError):
    """Base error raised by the simulated task service."""
